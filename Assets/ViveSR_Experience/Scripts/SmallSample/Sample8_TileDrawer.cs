...
namespace Vive.Plugin.SR.Experience
{
    ...
    public class Sample8_TileDrawer : MonoBehaviour
    {
        ...
        [SerializeField] ViveSR_Experience_TileSpawner TileSpawnerScript;
        [SerializeField] ViveSR_Experience_StaticMesh StaticMeshScript;
        ...
        public void HandleGrip_SwitchMode(ButtonStage buttonStage, Vector2 axis)
        {
            ...
            switch (buttonStage)
            {
                ...
                bool allowSwitch = StaticMeshScript.texturedMesh != null
        ...
        void Stop()
        {
            ...
            TriggerCanvas.SetActive(StaticMeshScript.CheckModelLoaded());
            ...
            else if (StaticMeshScript.CheckModelFileExist()) LoadText.color = BrightColor;
        ...
        void Save()
        {
            bool allowSave = ViveSR_RigidReconstruction.IsScanning && !ViveSR_RigidReconstruction.IsExportingMesh;
        ...
        void Load()
        {
            ...
            StaticMeshScript.LoadMesh(true, false, Load_before, Load_after);
        }
        void Load_before()
        {
            LoadText.color = OriginalColor;
        ...
        void Load_after()
        {
            StaticMeshScript.WaitForCldPool(Load_WaitForCldPool_done);
        }
