...
{
    [InitializeOnLoad]
    public class ViveSR_Experience_Settings : EditorWindow
    {
        static ViveSR_Experience_Settings window;
        static List<Page> SettingPages = new List<Page>();
        static int CountPage;
        static int CurrentPage;

        static ViveSR_Experience_Settings()
        {
        ...
        static void Init()
        {
            ...
            if (CountPage > 1)
            {
                window = GetWindow<ViveSR_Experience_Settings>(true, "Input Settings", true); // Show window
    ...
    public class ViveSR_Experience_Page_VRInput : ViveSR_Experience_Settings.Page
    {
    ...
    public class ViveSR_Experience_Page_Finish : ViveSR_Experience_Settings.Page
    {
