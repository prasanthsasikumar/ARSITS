    ...
    {   
        ...
        IEnumerator _CheckViveSRStatus(Action done = null)
        {
            ...
            while (ViveSR.FrameworkStatus == FrameworkStatus.INITIAL || ViveSR.FrameworkStatus == FrameworkStatus.START)
            {
                ...
                {
                    Debug.Log("[ViveSR Experience] ViveSR initial timeout. Quitting Game");
            ...
            {
                Debug.Log("[ViveSR Experience] ViveSR initial fail. Quitting Game");

                actionSequence.StopSequence();
                ViveSR_Experience.instance.ErrorHandlerScript.EnablePanel(ViveSR_Experience_ErrorHandler.ErrorIndex.InitialFail);
                this.Delay(QuitGame, 3f);
            }
        ...
        void CheckCurrentHMDDevice(Action done = null)
        {
            ...
            if (trackingSystem == "lighthouse") ViveSR_Experience.instance.CurrentDevice = DeviceType.Vive;
            else if (trackingSystem == "vive_eyes") ViveSR_Experience.instance.CurrentDevice = DeviceType.ViveT2;
            else ViveSR_Experience.instance.CurrentDevice = DeviceType.NotSupport;

            if (ViveSR_Experience.instance.CurrentDevice == DeviceType.NotSupport)
            {
        ...
        void OnHandDetected(Action done = null)
        {
            ...
            ViveSR_Experience.instance.PlayerHeadCollision.transform.parent = PlayerHead.transform;
            ViveSR_Experience.instance.PlayerHeadCollision.transform.localPosition = Vector3.zero;
            ViveSR_Experience.instance.PlayerHeadCollision.transform.localEulerAngles = Vector3.zero;
        ...
        { 
            switch (ViveSR_Experience.instance.scene)
            {
                ...
                case SceneType.Sample4:
                    FindObjectOfType<Sample4_StaticMesh>().Init(); break;
