...
[StructLayout(LayoutKind.Sequential)]
[Serializable]
public class GestureResult : IEquatable<GestureResult>{
  ...
  public GestureResult(bool isLeft, Vector3[] points, GestureType gesture, Vector3 position, Quaternion rotation)
  {
    this.isLeft = isLeft;
    this.points = points;
